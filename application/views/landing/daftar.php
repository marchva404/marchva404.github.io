				...
				<div class="card">
				  ...
				  <div class="card-body">
		              ...
		              <?= form_error('nama'); ?>
							...
							<div class="form-group">
								<label for="NIP"><i class="fas fa-fw fa-landmark"></i> NIP</label>
								<input type="text" id="NIP" class="form-control <?= (form_error('NIP')) ? 'is-invalid' : ''; ?>" name="NIP" required placeholder="18 digit NIP" required value="<?= set_value('NIP'); ?>">
								<div class="invalid-feedback">
		              <?= form_error('NIP'); ?>
		            </div>
							</div>
